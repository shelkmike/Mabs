...
11. What is the main downside of Mabs?<br>
I think, it is the fact that I made Mabs-flye instead of "Mabs-nextdenovo". When I started developing Mabs, I thought that Flye is the best assembler for Oxford Nanopore reads. However, I later realized that [NextDenovo](https://github.com/Nextomics/NextDenovo) usually makes better assemblies. If I knew this beforehand, I would have made a version of Mabs based on NextDenovo instead of a version based on Flye. Thus, if you assemble a genome using Oxford Nanopore reads, I definitely recommend to try NextDenovo apart from Mabs-flye.
